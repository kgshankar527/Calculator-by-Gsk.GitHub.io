...
miniToggle.addEventListener("click", () => {
  ...
  if (isFloating) {
    ...
    document.body.style.left = "1rem";
    document.body.style.top = "1rem";
...
// Floating drag by header
let floatingDrag = false, mouseOffsetX = 0, mouseOffsetY = 0;
document.querySelector("header").addEventListener("mousedown", function(e) {
  if (document.body.classList.contains("floating")) {
    floatingDrag = true;
    mouseOffsetX = e.clientX - document.body.offsetLeft;
    mouseOffsetY = e.clientY - document.body.offsetTop;
...
function dragFloating(e) {
  ...
  document.body.style.left = (e.clientX - mouseOffsetX) + "px";
  document.body.style.top = (e.clientY - mouseOffsetY) + "px";
